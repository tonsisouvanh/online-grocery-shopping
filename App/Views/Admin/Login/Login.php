    ...
    <div class="fm-wrapper">
      <div class="card">
        <div class="card-header">
          <h5><Strong>Đăng nhập (Người bán)</Strong></h5>
        </div>
        <div class="card-body">
          <form action="?action=merchant-login" method="POST">
        ...
        <div class="card-footer text-muted d-flex flex-column ">
          ...
          <a class="btn" <?php echo "href='$PATH_ROOT?action=merchant-register'"; ?>>Tạo tài khoản </a>
